...
public class MenuDAOTester {
    public static void main(String[] args) {
        ...
        MenuItem newItem = new MenuItem("Pizza", "Food", "Main Branch", "Yummy Pizza", 15.99f, true);
        ...
        MenuItem updatedItem = new MenuItem("Pizza", "Food", "Main Branch", "Yummy Pizza",17.99f,true);
